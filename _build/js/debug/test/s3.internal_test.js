...
function _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok.prototype.$tag = 1;
const _M0MP26mizchi2s334MoonBitTestDriverInternalTestEntry8filename = (entry) => entry[0];
const _M0MP26mizchi2s334MoonBitTestDriverInternalTestEntry5index = (entry) => entry[1];
function _M0DTPC15error5Error81mizchi_2fs3_2eMoonBitTestDriverInternalJsError_2eMoonBitTestDriverInternalJsError(param0) {
  this._0 = param0;
}
_M0DTPC15error5Error81mizchi_2fs3_2eMoonBitTestDriverInternalJsError_2eMoonBitTestDriverInternalJsError.prototype.$tag = 4;
...
function _M0DTPC15error5Error83mizchi_2fs3_2eMoonBitTestDriverInternalSkipTest_2eMoonBitTestDriverInternalSkipTest(param0) {
  this._0 = param0;
}
_M0DTPC15error5Error83mizchi_2fs3_2eMoonBitTestDriverInternalSkipTest_2eMoonBitTestDriverInternalSkipTest.prototype.$tag = 1;
...
const _M0FP26mizchi2s338moonbit__test__driver__js__parse__args = () => {
  try {
    let testParams = []
...
function _M0FP15Error10to__string(_e) {
  switch (_e.$tag) {
    ...
    case 1: {
      return "mizchi/s3.MoonBitTestDriverInternalSkipTest.MoonBitTestDriverInternalSkipTest";
    }
    case 0: {
      return _M0IP016_24default__implPB4Show10to__stringGRPB7FailureE(_e);
    }
    case 4: {
      return "mizchi/s3.MoonBitTestDriverInternalJsError.MoonBitTestDriverInternalJsError";
    }
    default: {
...
function _M0MPC15array5Array2atGRP26mizchi2s334MoonBitTestDriverInternalTestEntryE(self, index) {
  const len = self.length;
...
function _M0IP016_24default__implP26mizchi2s328MoonBit__Async__Test__Driver17run__async__testsGRP26mizchi2s334MoonBit__Async__Test__Driver__ImplE(_discard_) {}
function _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s341MoonBit__Test__Driver__Internal__No__ArgsE(_discard_, _discard_$2, _discard_$3, _discard_$4, _discard_$5) {
  return new _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok(false);
}
function _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s343MoonBit__Test__Driver__Internal__With__ArgsE(_discard_, _discard_$2, _discard_$3, _discard_$4, _discard_$5) {
  return new _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok(false);
}
function _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s348MoonBit__Test__Driver__Internal__Async__No__ArgsE(_discard_, _discard_$2, _discard_$3, _discard_$4, _discard_$5) {
  return new _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok(false);
}
function _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s350MoonBit__Test__Driver__Internal__Async__With__ArgsE(_discard_, _discard_$2, _discard_$3, _discard_$4, _discard_$5) {
  return new _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok(false);
}
function _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s350MoonBit__Test__Driver__Internal__With__Bench__ArgsE(_discard_, _discard_$2, _discard_$3, _discard_$4, _discard_$5) {
  return new _M0DTPC16result6ResultGbRP26mizchi2s333MoonBitTestDriverInternalSkipTestE2Ok(false);
}
function _M0FP26mizchi2s329moonbit__test__driver__finish() {}
function _M0FP26mizchi2s344moonbit__test__driver__internal__do__execute(async_tests, filename, index) {
  ...
  _L: {
    let _tmp;
    const _bind = _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s341MoonBit__Test__Driver__Internal__No__ArgsE(async_tests, filename, index, handle_result, error_to_string);
    let _tmp$2;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp$2 = _ok._0;
    ...
    if (_tmp$2) {
      ...
      let _tmp$3;
      const _bind$2 = _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s343MoonBit__Test__Driver__Internal__With__ArgsE(async_tests, filename, index, handle_result, error_to_string);
      let _tmp$4;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        _tmp$4 = _ok._0;
      ...
      if (_tmp$4) {
        ...
        let _tmp$5;
        const _bind$3 = _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s348MoonBit__Test__Driver__Internal__Async__No__ArgsE(async_tests, filename, index, handle_result, error_to_string);
        let _tmp$6;
        if (_bind$3.$tag === 1) {
          const _ok = _bind$3;
          _tmp$6 = _ok._0;
        ...
        if (_tmp$6) {
          ...
          let _tmp$7;
          const _bind$4 = _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s350MoonBit__Test__Driver__Internal__Async__With__ArgsE(async_tests, filename, index, handle_result, error_to_string);
          let _tmp$8;
          if (_bind$4.$tag === 1) {
            const _ok = _bind$4;
            _tmp$8 = _ok._0;
          ...
          if (_tmp$8) {
            ...
            const _bind$5 = _M0IP016_24default__implP26mizchi2s321MoonBit__Test__Driver9run__testGRP26mizchi2s350MoonBit__Test__Driver__Internal__With__Bench__ArgsE(async_tests, filename, index, handle_result, error_to_string);
            let _tmp$9;
            if (_bind$5.$tag === 1) {
              const _ok = _bind$5;
              _tmp$9 = _ok._0;
    ...
    if (!_tmp) {
      _try_err = new _M0DTPC15error5Error83mizchi_2fs3_2eMoonBitTestDriverInternalSkipTest_2eMoonBitTestDriverInternalSkipTest("");
      break _L;
    } else {
      return;
    }
...
function _M0FP26mizchi2s340moonbit__test__driver__internal__execute(tests) {
  const async_tests = [];
  const _bind = 0;
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const entry = _M0MPC15array5Array2atGRP26mizchi2s334MoonBitTestDriverInternalTestEntryE(tests, i);
      _M0FP26mizchi2s344moonbit__test__driver__internal__do__execute(async_tests, _M0MP26mizchi2s334MoonBitTestDriverInternalTestEntry8filename(entry), _M0MP26mizchi2s334MoonBitTestDriverInternalTestEntry5index(entry));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  _M0IP016_24default__implP26mizchi2s328MoonBit__Async__Test__Driver17run__async__testsGRP26mizchi2s334MoonBit__Async__Test__Driver__ImplE(async_tests);
}
(() => {
  const test_params = _M0FP26mizchi2s338moonbit__test__driver__js__parse__args();
  _M0FP26mizchi2s340moonbit__test__driver__internal__execute(test_params);
  _M0FP26mizchi2s329moonbit__test__driver__finish();
})();
exports.moonbit_test_driver_finish = _M0FP26mizchi2s329moonbit__test__driver__finish;
exports.moonbit_test_driver_internal_execute = _M0FP26mizchi2s340moonbit__test__driver__internal__execute;
//# sourceMappingURL=s3.internal_test.js.map
